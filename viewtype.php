...
$sql = "SELECT type_ID, type_name, type_status FROM type";
...
<div class = "profile">
    ...
    <h1>Type Details</h1>
        ...
        <div class='header'>
            <div class='cell'>Type ID</div>
            <div class='cell'>Type Name</div>
            <div class='cell'>Type Status</div>
        </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        $checked = (($row["type_status"]=="active") ? "active" : "not active");  
        echo "<div class='row'>
                <div class='cell'>" . $row["type_ID"] . "</div>
                <div class='cell'>" . $row["type_name"] . "</div>
