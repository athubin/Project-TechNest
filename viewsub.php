...
<div class = "profile">
    ...
    <h1>Sub-Category Details</h1>
        ...
        <div class='header'>
            <div class='cell'>Sub-Category ID</div>
            <div class='cell'>Sub-Category Name</div>
            <div class='cell'>Sub-Category Status</div>
        </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        echo "<div class='row'>
                <div class='cell'>" . $row["sid"] . "</div>
                <div class='cell'>" . $row["s_name"] . "</div>
                <div class='cell'>" . $row["s_status"] . "</div>
              </div>";
    }
} else {
